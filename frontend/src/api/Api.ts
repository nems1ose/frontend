...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  films = {
     ...
     * @secure
     */
    filmsUpdateUpdate: (filmId: string, data: Film, params: RequestParams = {}) =>
  ...
  historys = {
     ...
     * @secure
     */
    historysUpdateStatusAdminUpdate: (historyId: string, data: UpdateHistoryStatusAdmin, params: RequestParams = {}) =>
